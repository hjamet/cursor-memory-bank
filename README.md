...
| `monitor` | **Superviseur de Boucle**. Commande globale Windows permettant de lancer et surveiller une exécution de longue durée, d'adapter la roadmap en direct via l'Architecte sur retour utilisateur, et de relancer l'agent automatiquement en cas de plantage. | `monitor` (depuis n'importe quel projet Windows) |
