---
name: audit
description: "Vérificateur critique de l'implémentation. Compare le transcript du Build et le walkthrough avec le plan d'implémentation, traque les écarts et erreurs silencieuses."
---

# 🔍 Comment le Workflow Audit Vérifie-t-il l'Implémentation et la Non-Régression ?
