---
name: prompt
description: "Générateur de prompt de passation structuré pour guider le prochain agent vers un nouvel objectif."
---

# ✍️ Comment Rédiger un Prompt de Passation Efficace Entre Agents ?
